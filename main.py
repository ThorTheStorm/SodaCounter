...
def main():
    ...
    # Menu-options for the function main_menu:
    options =  {
    ...
    try:
        ...
        while (user_exit == False):
            ...
            if not (valid_dictionary(database_data)):
                ...
                user_selected_option = dict(main_menu(options)) #select_option(int(input("\nInput number for option: ")))
                ...
                #ser_subtract_input = user_confirm("\n\nWanna subtract from your inventory?")
                    ...
                    print(f"{'Index':<10} {'Soda':<20} {'Value':<5}")
                    print("-" * 40)
                    for index, (key, value) in enumerate(database_data.items()):
                        print(f"{index:<10} {key:<20} {value:<5}")
                    
                    user_input_item_to_subtract = int(input("Select index for soda: "))
                ...
                #ser_subtract_input = user_confirm("\n\nWanna subtract from your inventory?")
                    ...
                    user_input_item_to_add = int(input("Select index for soda: "))
